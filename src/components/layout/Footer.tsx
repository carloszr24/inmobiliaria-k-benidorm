...
export function Footer() {
  ...
  return (
    <footer className="mt-24 border-t border-brand-blue-dark bg-brand-blue-dark text-stone-300">
      <div className="max-w-7xl mx-auto px-6 md:px-10 py-16">
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-stone-400">
