              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full border border-stone-200 px-4 py-3 text-sm focus:outline-none focus:border-brand-blue transition-colors"
                    />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full border border-stone-200 px-4 py-3 text-sm focus:outline-none focus:border-brand-blue transition-colors resize-none"
                  />
                </div>
