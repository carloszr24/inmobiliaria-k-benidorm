...
export default async function PropertyDetailPage({
  ...
  const images = parseImages(property.images).map(resolveImageUrl)
              ...
              <div className="space-y-3">
                ...
                {property.fotocasaUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-full block text-center text-sm py-4 border border-brand-blue text-brand-blue hover:bg-brand-blue hover:text-white transition-colors duration-200"
                  >
