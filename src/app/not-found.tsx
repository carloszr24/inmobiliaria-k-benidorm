  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 pt-16">
      <div className="text-center">
        ...
        <p className="text-stone-500 mb-10">La página que buscas no existe o ha sido movida. Puedes volver al inicio y explorar inmuebles en Benidorm y la Costa Blanca.</p>
